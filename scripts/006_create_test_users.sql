-- Script pour créer les utilisateurs de test avec leurs profils
-- Ce script utilise l'API Supabase Auth pour créer les utilisateurs

-- IMPORTANT: Ce script doit être exécuté avec les privilèges admin de Supabase
-- Il crée les utilisateurs dans auth.users ET leurs profils associés
